...
ModelMesh Model::processMesh(aiMesh* mesh, const aiScene* scene) {
  ...
  // normal maps
  std::vector<ModelTexture> normalMaps = loadMaterialTextures(material,
                                                              aiTextureType_HEIGHT,
                                                              "texture_normal");
  textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());

  // height maps
  std::vector<ModelTexture> heightMaps = loadMaterialTextures(material,
...
std::vector<ModelTexture> Model::loadMaterialTextures(const aiMaterial* mat,
